...
public class ExtendibleHashFileEcvIndexDebugWindowViewModel : ExtendibleHashFileDebugView.ViewModels.ViewModelBase
{
    private EhfDebug<KeyToBlockAddress<EcvKey>> _ehfDebug = new();

    public EhfDebug<KeyToBlockAddress<EcvKey>> EhfDebug
    {
        get => _ehfDebug;
        set
        {
